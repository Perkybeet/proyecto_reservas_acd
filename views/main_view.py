...
def main_view(page: ft.Page):
    ...
    # Instanciar las vistas pasando la instancia de Page
    ...
    nav_bar = ft.Row(
        controls=[
            ...
            # Puedes agregar más botones para otros recursos
        ],
